...
import kr.jay.remittance.adapter.out.persistence.RemittanceRequestMapper;
...
public class RequestRemittanceService implements RequestRemittanceUseCase {
	...
	@Override
	public RemittanceRequest requestRemittance(final RequestRemittanceCommand command) {
